...
export const COPY = {
  ...
  // --- Concert Builder (§13) ---------------------------------------------
  // C32
  buildCardTitle: 'Build a concert',
  buildCardSub: 'Make your own schedule — works offline',
  // C33 ({d}, {n}, {when})
  buildsSectionLabel: 'Your builds',
  buildRowSub: '{d} · {n} · edited {when}',
  buildChipReady: 'Ready',
  buildChipDraft: 'Draft',
  // C34
  stepDetails: 'Concert details',
  stepDays: 'Days',
  stepStages: 'Stages',
  stepPerformances: 'Performances',
  // C35 ({n})
  readinessTitle: 'Almost there — {n} to go',
  gapName: 'Name your concert',
  gapTimezone: 'Set a timezone',
  gapDays: 'Add at least one day',
  gapStages: 'Add at least one stage',
  gapPerformances: 'Add at least one set',
  gapIncompleteSets: 'Finish {n} incomplete set(s)',
  // C36
  planBuildCta: 'Plan this concert',
  // C37
  exportTitle: 'Share this concert',
  exportBody: 'One JSON file with the lineup — days, stages and sets. Your picks, custom events and edits stay on this device.',
  exportDownload: 'Download',
  exportShare: 'Share',
  // C38
  editACopyCta: 'Edit a copy',
  // C39 ({concert})
  deleteBuildTitle: 'Delete this build?',
  deleteBuildBody: '{concert} will be removed from this device. A concert you already planned from it stays put.',
  deleteBuildConfirm: 'Delete build',
  deleteBuildKeep: 'Keep it',
  // C40 — builder toasts
  toastBuildCreated: 'New build started — add your days next.',
  toastExported: '{concert} exported — v{n} is ready to share. 🎫',
  toastExportBlocked: 'Add {what} before you can share this one.',
  toastPlannedFromBuild: '{concert} is on your list — let\'s plan it.',
  toastForked: 'Copied — {concert} is yours to edit now.',
  toastBuildDeleted: 'Build deleted.',
  toastStageRemoved: '{stage} removed — {n} set(s) moved to {other}.',
  toastStageClash: '{stage} has two sets at once — check the times.',
  toastReimportStale: 'That file is v{n} — you already have v{m}. Keeping yours.',
  toastReimportNewer: 'Updated to v{n} — your plan survived the update. ✨',
  toastEventIdTaken: 'That id is taken on this device — try {suggestion}.',
} as const
...
export const DESIGN_COPY = {
  ...
  // --- Concert Builder screen microcopy (design.pen §13.3, new copy) ------
  buildsEmptyHint: 'Nothing built yet — start one below.',
  builderNewTitle: 'New build',
  detailsSub: 'The basics that show up on the concert card.',
  fieldName: 'Name',
  fieldPlace: 'Place',
  fieldDescription: 'Description',
  fieldTimezone: 'Timezone',
  fieldLogo: 'Logo URL',
  fieldOptional: 'https://… (optional)',
  advancedLabel: 'Advanced',
  eventIdNote: 'Ships inside the export, so it must be unique on this device. Changing it won\'t touch a concert you already planned.',
  autosaveNote: 'Saved as you type.',
  daysSub: 'Add the dates you\'re running. Day 1 is simply the earliest one.',
  daysNote: 'Tap a date to change it — day numbers re-order themselves and the sets follow.',
  addDayCta: 'Add a day',
  removeDayTitle: 'Remove this day?',
  removeDayBody: '{n} set(s) on {date} will be deleted with it.',
  removeDayConfirm: 'Remove day',
  stagesSub: 'Give each one a colour — it carries through the whole timetable.',
  addStageCta: 'Add a stage',
  stageColourLabel: '{stage} · colour',
  clampNote: 'Extreme picks get nudged into a readable band, and label colour flips to suit — the preview below is the real result.',
  removeStageTitle: 'Remove this stage?',
  removeStageBodyEmpty: '{stage} has no sets on it.',
  removeStageBodyReassign: '{n} set(s) will move to {other}.',
  removeStageBodyDelete: '{n} set(s) will be deleted with it — there\'s no other stage to move them to.',
  removeStageConfirm: 'Remove stage',
  performancesSub: '{n} across {d}. Clashes between stages are fine — those are the ones people will have to choose between.',
  addSetCta: 'Add a set',
  setSheetAddTitle: 'Add a set',
  setSheetEditTitle: 'Edit this set',
  fieldArtist: 'Artist',
  fieldArtistImage: 'Artist image URL',
  fieldDay: 'Day',
  fieldStage: 'Stage',
  fieldStarts: 'Starts',
  fieldEnds: 'Ends',
  midnightNote: 'An end time at or before the start means the set runs past midnight — it stays on Day {x}.',
  addSetConfirm: 'Add set',
  saveSetConfirm: 'Save set',
  removeSetCta: 'Remove this set',
  readyTitle: 'Ready to go',
  readySub: '{d} · {s} · {n}',
  buildActionsNote: 'Editing this build later won\'t touch a concert you\'ve already planned from it.',
  exportFileMeta: '{size} · {d} · {s} · {n}',
  exportIncludesLineup: 'Days, stages and every set',
  exportIncludesMeta: 'Name, place, description and timezone',
  exportExcludesPlan: 'Your picks, backburners and custom events',
  exportFooter: 'Whoever gets it opens it from their home screen — Upload concert JSON.',
  noStagesYet: 'Add a stage first — every set needs one.',
  noDaysYet: 'Add a day first — every set needs one.',
} as const
